...
import { emptyValidatedInputField, IProject, IValidatedInputField } from '../../models'
...
const Projects: React.FC = () => {
  ...
  const handleSave = async (material: IProject) => {
    try {
      if (draft) await ProjectService.updateProjects({ ...material, id: draft.id })
      else await ProjectService.createProject(material)
    } catch (error) {
